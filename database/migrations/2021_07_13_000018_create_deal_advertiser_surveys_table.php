...
class CreateDealAdvertiserSurveysTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('deal_advertiser_surveys', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('deal_advertiser_surveys');
    }
}
